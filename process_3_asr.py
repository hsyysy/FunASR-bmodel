...
model_asr = AutoModel(model=model_dir+"speech_seaco_paraformer_large_asr_nat-zh-cn-16k-common-vocab8404/models/"+target, device="cpu", disable_update=True, disable_pbar=True, dev_id=dev_id)
#model_asr = AutoModel(model=model_dir+"speech_paraformer-large-contextual_asr_nat-zh-cn-16k-common-vocab8404/models/"+target, device="cpu", disable_update=True, disable_pbar=True, dev_id=dev_id)
