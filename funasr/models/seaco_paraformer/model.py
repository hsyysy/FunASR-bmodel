...
class SeacoParaformer(BiCifParaformer, Paraformer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        #self.encoder_bmodel = EngineOV(kwargs["model_path"]+"/encoder2_f16_b10.bmodel", device_id=kwargs['dev_id'])

        self.predictor_bmodel = EngineOV(kwargs["model_path"]+"/predictor_fp32_10b.bmodel", device_id=kwargs['dev_id'])
        #self.predictor_bmodel = EngineOV(kwargs["model_path"]+"/predictor_f16_b10.bmodel", device_id=kwargs['dev_id'])
